...
export function RootLayout() {
    ...
    const treeMenuActive = pathname === '/convert' || pathname === '/viewer' || pathname === '/upload'
                            ...
                            {treeMenuOpen && (
                                <div role="menu" className="absolute left-0 top-full mt-1 w-52 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] shadow-lg overflow-hidden z-40">
                                    <Link
                                        to="/viewer"
                                        role="menuitem"
                                        className={`flex items-start gap-2.5 px-3 py-2 text-sm hover:bg-[var(--color-surface-hover)] transition-colors ${pathname === '/viewer' ? 'bg-[var(--color-surface-hover)] text-[var(--color-text)]' : 'text-[var(--color-text-muted)]'}`}
                                    >
                                        ...
                                        <span className="flex-1">
                                            <span className="block font-medium text-[var(--color-text)]">Viewer</span>
                                            <span className="block text-xs text-[var(--color-text-faint)]">Paste &amp; inspect a tree</span>
                                        </span>
                                    </Link>
                                    <Link
                                        to="/convert"
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden border-t border-[var(--color-border-subtle)] bg-[var(--color-bg)] px-4 py-4 space-y-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <Link
                                to="/viewer"
                                className={`rounded-md px-3 py-2 text-sm font-medium transition-colors ${pathname === '/viewer' ? 'bg-[var(--color-surface)] text-[var(--color-text)]' : 'text-[var(--color-text-muted)] hover:bg-[var(--color-surface)] hover:text-[var(--color-text)]'}`}
                            >
                                Viewer
                            </Link>
                            <Link
